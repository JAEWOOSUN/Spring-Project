...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-card">
            <img class="sidebar-card-illustration mb-2" src="${resources}/vendor/sb-admin-2/img/undraw_rocket.svg" alt="">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                         src="${resources}/vendor/sb-admin-2/img/undraw_posting_photo.svg" alt="">
                                </div>
